        ...
        <div className='accordion' id='accordionExample'>
          ...
          <div className='accordion-item'>
            <p className='accordion-header' id='headingTwo'>
              ...
              >
                Diálogo de las Naciones y Pueblos Indígenas
              </button>
            </p>
            <div
              id='collapseTwo'
          ...
          <div className='accordion-item'>
            <p className='accordion-header' id='headingThree'>
              ...
              >
                Diálogo sobre la Vía de Acción 4
              </button>
            </p>
            <div
              id='collapseThree'
          ...
          <div className='accordion-item'>
            <p className='accordion-header' id='headingFour'>
              ...
              >
                Diálogo sobre la Vía de Acción 5
              </button>
            </p>
            <div
              id='collapseFour'
          ...
          <div className='accordion-item'>
            <p className='accordion-header' id='headingFive'>
              ...
              >
                Diálogo con el Pacto de Unidad
              </button>
            </p>
            <div
              id='collapseFive'
          ...
          <div className='accordion-item'>
            <p className='accordion-header' id='headingSix'>
              ...
              >
                Diálogo con organizaciones de la juventud
              </button>
            </p>
            <div
              id='collapseSix'
